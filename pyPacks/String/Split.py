...
if __name__ == "__main__":
    ...
    #
    #
    oOut, lBegText, lBegSplits = getPartsIterAndBothStarts( sTest0, lowercase )
    #
    ...
    if      getPartsAndPositionsUseFinder( sOrig0, oFinderTableTag ) != \
        ...
        #
    #
    if      getCharPositions( sOrig0, '<table>' ) != [7, 20, 33, 47] or \
            getCharPositions( sOrig1, '<table>' ) != [7, 20, 33, 47] or \
            getCharPositions( sOrig2, '<table>' ) != [7, 20, 33, 47]:
        #
