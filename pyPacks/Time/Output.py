...
def getNowIsoDateTimeNoSpaces( bWantLocal = True ):
    #
...
def getNowIsoDateTimeNoSpacesNoSeconds( bWantLocal = True ):
    #
    sNow = getNowIsoDateTimeNoSpaces( bWantLocal = bWantLocal )
    #
    return sNow[ : 16 ]
...
if __name__ == "__main__":
    ...
    sNone  = getNowIsoDateTimeNoSpaces()
    sNoSec = getNowIsoDateTimeNoSpacesNoSeconds()
    #
    if sSpace.replace( ' ', '_' ) != sNone:
        #
        print3( 'getNowIsoDateTimeStr():     ', sSpace )
        print3( 'getNowIsoDateTimeNoSpaces():', sNone  )
        #
